...
export default function Footer() {
  ...
  return (
    <footer className={styles['footer']} aria-labelledby="footer-logo">
      ...
      <div className={styles['footer__watermark']} aria-hidden="true">
        DRIFULLY
      </div>
      ...
      <div className={`container ${styles['footer__container']}`}>
        ...
        <div className={styles['footer__grid']}>
          ...
          {/* Link columns */}
          <div className={styles['footer__column__grid']}>
            <div className={styles['footer__nav-col']}>
              ...
              <ul className={styles['footer__links']}>
                ...
                <li><Link href="/drive-with-drifully" className={styles['footer__link']}>Become a Driver</Link></li>
              </ul>
            </div>
          ...
          {/* Newsletter column */}
          <div className={styles['footer__newsletter-col']}>
            <h3 className={styles['footer__col-title']}>Newsletter</h3>
      ...
      <div className={styles['footer__bottom']}>
        <div className={`container ${styles['footer__bottom-container']}`}>
          <p className={styles['footer__copy']}>
            © {year} Drifully. All rights reserved.
          </p>

          <div className={styles['footer__socials']}>
            <Link href="https://x.com/drifullyrentals?s=11" className={styles['footer__social-link']} aria-label="X">
            ...
            <Link href="https://www.facebook.com/share/1YiruGKukG/?mibextid=wwXIfr" className={styles['footer__social-link']} aria-label="Facebook">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
            </Link>
            <Link href="https://www.instagram.com/drifullycarrentals?utm_source=qr" className={styles['footer__social-link']} aria-label="Instagram">
